...
*Última actualización: 2026-05-09 — **Referencias de entorno:** API pública / OpenAPI / `GET /api/public/version` con base **`https://rezerva.cl`** (alineado a `servers` en YAML). Historial 2026-05-07: paquete MCP `rezerva-mcp-server`; regla `50`; `coordinacion-cursor-paralelo.md`.*