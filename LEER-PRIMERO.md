...
| **CSS / UI**                                                                 | Tokens en `backend/tailwind.config.js`; capa de componentes en `frontend/public/css/source.css`; estándar operativo (layout, sidebar, responsive, botones, build CSS): **`.cursor/rules/20-frontend-design-system.mdc`**. Botones de panel: `.btn-primary`, `.btn-outline`, `.btn-danger`, `.btn-success`, `.btn-warning`, etc.       |
