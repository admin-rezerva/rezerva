...
| Fecha      | Autor       | Cambio                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-05-09 | Cursor      | **Deps Node alineadas local ↔ CI:** `node_modules/` en la raíz **deja de versionarse**; CI instala raíz + `backend/` (`npm ci` con `working-directory: backend`). Detalle en §2.1.                                                                                                                                                                                            |
...
**Dependencias Node (misma secuencia que CI):** hay dos `package.json`: raíz (scripts `npm run …`, p. ej. `test:ci`) y `backend/` (servidor, `pg`, Express). Tras clonar o cambiar de rama: `npm ci` en la raíz y luego `cd backend && npm ci` (equivalente a `npm ci --prefix backend`). **No** commitear carpetas `node_modules/` (quedan ignoradas por `.gitignore`).
