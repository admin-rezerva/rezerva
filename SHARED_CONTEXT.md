...
| Fecha      | Autor       | Cambio                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-05-09 | Cursor      | **Deps Node local ↔ CI:** `node_modules/` raíz no versionado; CI: `npm ci` raíz + `backend` `npm install --omit=dev` (smoke; evita `npm ci --omit=dev` roto en runner). §2.1.                                                                                                                                                                                            |
...
**Dependencias Node (misma secuencia que CI):** dos `package.json`: raíz (`npm run test:ci`, …) y `backend/`. Tras clonar: `npm ci` en la raíz; en `backend/` para desarrollo completo `npm ci`; para alinear con el smoke de Actions (solo prod): `npm install --omit=dev` (mismo lockfile). **No** commitear `node_modules/`.
