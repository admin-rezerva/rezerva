...
| `20-frontend-design-system.mdc` | SPA + EJS + `source.css` | Design system admin: tokens, pipeline CSS, shell/scroll, sidebar, botones, tablas, responsive, calendario, auditoría UI |
