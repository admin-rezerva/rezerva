...
| `SM-mail-events-mtx` | Correos transaccionales — flujo, plantillas, notificaciones y matriz de eventos | En curso (Cursor) | — | `tema/SM-mail-events-mtx` | Cursor | 2026-05-13 — Doc producto: `producto-abono-deposito-canales-y-ui.md` (alcance «Requiere abono», textos legales vs internos, OTA pendiente, agrupación cuenta bajo abono). Código previo: admin sin caja blanca duplicada. | `tema/SM-mail-events-mtx/producto-abono-deposito-canales-y-ui.md`, `plantillasEmailTemplates.js`, `plantillasService.js` |
