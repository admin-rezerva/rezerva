...
| `SM-spa-mobile-ui` | SPA responsive (gestión diaria, modales) | En curso (Cursor) | — | `tema/SM-spa-mobile-ui` | Cursor | 2026-05-10 — Simulador Rentabilidad: tarjetas en **columna única** en móvil (`grid-cols-1 md:grid-cols-2`). Antes: pestañas scroll + push `ed50f75`/`38dbffc`. | `tema/SM-spa-mobile-ui/README.md`, `ajusteTarifaModal.js` |
