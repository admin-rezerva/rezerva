...
| `SM-mail-events-mtx` | Correos transaccionales — flujo, plantillas, notificaciones y matriz de eventos | En curso (Cursor) | — | `tema/SM-mail-events-mtx` | Cursor | 2026-05-13 — Fix plantillas PG antiguas: `procesarPlantilla` infiere modo confirmación por contenido HTML + inserta `[BLOQUE_ABONO_TRANSFERENCIA_*]` si faltaba; ayuda UI depósito web (qué va en sitio vs empresa). | `plantillasService.js`, `webPublica.general.unified.markup.js` |
