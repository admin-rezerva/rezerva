...
| `SM-mail-events-mtx` | Correos transaccionales — flujo, plantillas, notificaciones y matriz de eventos | En curso (Cursor) | — | `tema/SM-mail-events-mtx` | Cursor | 2026-05-10 — Motor: `[DESGLOSE_PRECIO_HTML]` (multipropiedad desde metadata checkout), `[LINK_FOTOS_ALOJAMIENTO]`, `[ENLACES_FOTOS_ALOJAMIENTOS_HTML]`; Maps desde columna `google_maps_url` + config; prompt/preset sin “Qué hacer cerca”. | `transactionalEmailService.js`, `plantillasEtiquetasCatalog.js`, `plantillasIa.js` |
