...
| `SM-mail-events-mtx` | Correos transaccionales — flujo, plantillas, notificaciones y matriz de eventos | En curso (Cursor) | — | `tema/SM-mail-events-mtx` | Cursor | 2026-05-10 — Doc preset HTML admin/cliente (port React→email): `plantillas-preset-html-gemini-react-port.md`. **Pendiente:** pegar en panel por empresa; bloques EDITAR sin etiquetas motor (tinaja/WiFi/maps). | `plantillas-preset-html-gemini-react-port.md` |
