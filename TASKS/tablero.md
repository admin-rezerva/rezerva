...
| `SM-spa-mobile-ui` | SPA responsive (gestión diaria, modales) | En curso (Cursor) | — | `tema/SM-spa-mobile-ui` | Cursor | 2026-05-10 — Modal Ajuste tarifa: pestañas con scroll horizontal en móvil. **Push `main`:** `ed50f75`. Render desplegará con el build habitual (CSS ya en `style.css`). | `tema/SM-spa-mobile-ui/README.md`, `frontend/src/views/components/gestionDiaria/modals/ajusteTarifaModal.js` |
