...
| `SM-rebrand-dominio` | Rebrand dominio (suitemanagers.com → rezerva.cl) + limpieza Firebase | En curso (Cursor) | — | `tema/SM-rebrand-dominio` | Cursor | 2026-05-08 — SPA en host Render; marketplace en **`PLATFORM_DOMAIN`**. Marca marketplace sin SuiteManagers hardcode. **Pendiente:** OAuth rotado; Fase 4 PG; `verify-subdomain-logic` | `tema/SM-rebrand-dominio/pendientes-y-registro.md`, `plan-accion-rebrand.md`, `README.md` |
