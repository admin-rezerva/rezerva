...
| `SM-spa-mobile-ui` | SPA responsive (gestión diaria, modales) | En curso (Cursor) | — | `tema/SM-spa-mobile-ui` | Cursor | 2026-05-10 — Copy **Registrar pago** / **Autorizar Google**: marca desde `platformConfig` + env `PLATFORM_PRODUCT_NAME`/`PLATFORM_DOMAIN` (sin "StayManager"). `openManagementModal` async para modal pagos. | `tema/SM-spa-mobile-ui/README.md`, `pagosModal.js`, `platformConfig.js` |
