...
| `SM-spa-mobile-ui` | SPA responsive (gestión diaria, modales) | En curso (Cursor) | — | `tema/SM-spa-mobile-ui` | Cursor | 2026-05-10 — **EN CURSO:** Modal Ajuste tarifa — pestañas con scroll horizontal (`overflow-x-auto`, `hide-scrollbar`, `flex-shrink-0`, `scrollIntoView` al cambiar). `ajusteTarifaModal.js`, `gestionDiaria.js` (`min-w-0` + `overflow-x-hidden` en contenedor modal). Push a `main` para Render. | `tema/SM-spa-mobile-ui/README.md`, `frontend/src/views/components/gestionDiaria/modals/ajusteTarifaModal.js` |
