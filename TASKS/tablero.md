...
| `SM-mail-events-mtx` | Correos transaccionales — flujo, plantillas, notificaciones y matriz de eventos | En curso (Cursor) | — | `tema/SM-mail-events-mtx` | Cursor | 2026-05-13 — Admin confirmación: quitada caja blanca duplicada «Estado de pago»; solo bloque amarillo abono/transferencia. Heurísticas plantilla PG sin esa caja. | `plantillasEmailTemplates.js`, `plantillasService.js` |
